...
5.发布时间必须使用完整剧情日期与时间；预估耗时必须根据任务内容填写合理时长，使用“x小时”或“x天”格式，不得填写截止日期。发布者必须优先填写【角色卡信息】或故事背景中与任务相关的明确角色姓名；只有找不到可用的角色姓名时，才填写发布任务的组织、机构或组织联系人名称。不得在已有明确姓名或组织时使用“万象任务中心”等泛称。
...
9.必须参考【当前手机时间】生成合理的发布时间，并根据任务目标、地点、风险和执行要求估算合理耗时。`,
                    order: 1
                }
            },
