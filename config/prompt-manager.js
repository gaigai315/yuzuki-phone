...
7. 线下见面触发：如果剧情发展到你们即将面对面碰头（例如：你到了对方门外、两人在约定地点看到了对方），请在消息内容的最后面加上 [转线下] 标签，系统会自动关闭手机并推进现实剧情。例如：我到了，开门[转线下]
8. 禁止替{{user}}回复内容
...
4. 核心叙事协议有限调用：
   ...
   - 角色生态网格互动：若有多人（主播与联播观众），互动必须是网状的。非联播时，主播严禁仅与{{user}}交流，必须与评论区不同角色交流（一次可与多位观众交互）。
   - NSFW场景创作指南：严格遵循词汇、流程与感官细节标准。
5. 边界定义：此微型场景严格隔离于主线世界，仅为{{user}}“观察”到的信息，不产生直接物理影响。`,
                    order: 30
                }
            },
